#ifndef LAPPDDecodeRawWaveform_H
#define LAPPDDecodeRawWaveform_H
...
*/
class LAPPDDecodeRawWaveform: public Tool {


 public:

  LAPPDDecodeRawWaveform(); ///< Simple constructor
 ...
 private:
    ...
    int NChannels;
    int Nsamples;
    int NUM_VECTOR_DATA1;
    int NUM_VECTOR_PPS1;
    int TrigChannel;
    int LAPPDDecodeRawWaveformVerbosity=0;
    int eventNo;
